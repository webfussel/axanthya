...
public class WorldGeneration_Swampy : WorldGeneration_Terrain
{
    
    [SerializeField] int countContinents = 3;
    [SerializeField] float heightNoiseResolution = 0.05f, heightNoiseScale = 10f; // scale bigger => wilder islands, resolution bigger => bigger chunks of land
